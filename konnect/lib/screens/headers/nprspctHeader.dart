...
import '../../myScreen/incentive_view.dart';
import '../../myScreen/prospect_view.dart';
import '../../myScreen/prospects_list_view.dart';
import '../../myScreen/water_view.dart';
import '../../ui_view/title_view.dart';

class nprspctHeader extends StatefulWidget {
  const nprspctHeader({Key? key, this.animationController}) : super(key: key);
  final AnimationController? animationController;

  @override
  _NewnprspctHeaderState createState() => _NewnprspctHeaderState();
}

class _NewnprspctHeaderState extends State<nprspctHeader>
