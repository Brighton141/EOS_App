...
class repaymentHeader extends StatefulWidget {
  const repaymentHeader({Key? key, this.animationController}) : super(key: key);
  final AnimationController? animationController;

  @override
  _NewrepaymentHeaderState createState() => _NewrepaymentHeaderState();
}

class _NewrepaymentHeaderState extends State<repaymentHeader>
