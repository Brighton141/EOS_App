...
class newProspectScreen extends StatefulWidget {
  const newProspectScreen({Key? key, this.animationController}) : super(key: key);

  final AnimationController?animationController;

  @override
  _NewProspectScreenState createState() => _NewProspectScreenState();
}

class _NewProspectScreenState extends State<newProspectScreen>
  ...
  void initState() {
    ...
    tabBody = nprspctHeader(animationController: animationController);
    super.initState();
  }
